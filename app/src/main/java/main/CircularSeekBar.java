...
public class CircularSeekBar extends View {
    ...
    protected static final int DEFAULT_CIRCLE_PROGRESS_COLOR = Color.argb(255, 0, 0, 0);
    protected static final int DEFAULT_POINTER_COLOR =              Color.argb(235, 255, 255, 255);
    protected static final int DEFAULT_POINTER_HALO_COLOR =         Color.argb(135, 255, 255, 255);
    protected static final int DEFAULT_POINTER_HALO_COLOR_ONTOUCH = Color.argb(135, 255, 255, 255);
    ...
    protected static final int DEFAULT_POINTER_ALPHA_ONTOUCH = 200;
    ...
    protected void initPaints() {
        ...
        mProgressTextPaint.set(mPointerPaint);
        mProgressTextPaint.setColor(Color.WHITE);
        mProgressTextPaint.setStrokeWidth(1f);
        mProgressTextPaint.setTextSize(40.0f);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText(String.valueOf(getProgress()) + "%", -20, 0, mProgressTextPaint);
    }
